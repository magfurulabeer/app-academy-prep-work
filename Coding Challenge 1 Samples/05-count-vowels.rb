...
def count_vowels(string)
  string.scan(/[aeiou]/).length							# Option 1: Scan for all vowels into an array and rreturn length

# string.chars.find_all{|x| /[aeiou]/ === x}.length		# Option 2: Break string into chars and find length all array of vowels
end
